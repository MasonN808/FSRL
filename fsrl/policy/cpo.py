...
class CPO(BasePolicy):
    ...
    def _get_objective(
        self, logp: torch.Tensor, logp_old: torch.Tensor, adv: torch.Tensor) -> torch.Tensor:
    ...
    def policy_loss(self, minibatch: Batch) -> Tuple[torch.Tensor, dict]:
        ...
        # The objective gradient [Equation (11) https://arxiv.org/abs/1705.10528]
